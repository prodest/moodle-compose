...
$string['curlsecurityallowedport'] = 'Lista cURL de portas permitidas';
...
$string['curlsecurityblockedhosts'] = 'Lista cURL de hosts bloqueados';
...
$string['iplookupinfo'] = 'Por padrão, o Moodle usa o servidor on-line gratuito NetGeo (Internet Geographic Database) para pesquisar o local dos endereços IP, infelizmente esse banco de dados não é mais mantido e pode retornar dados <em> incrivelmente incorretos.
